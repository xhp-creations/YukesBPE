...
#define HASHSIZE 65536 		/* size of hash table */
#define MAXCHARS 210 		/* char set per block */
#define THRESHOLD 0 		/* minimum pair count */
...
extern "C"
{
	__declspec(dllexport) int bpe_file_compress ( char* infilename, char* outfilename, 
               int bs, int hs, int mc, int th )
{
  FILE *infile, *outfile;
/* argc = 7              */
